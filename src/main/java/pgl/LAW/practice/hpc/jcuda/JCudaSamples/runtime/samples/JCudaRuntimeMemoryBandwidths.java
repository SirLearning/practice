package pgl.LAW.practice.hpc.jcuda.JCudaSamples.runtime.samples;
/*
 ...
 * <ul>
 *   <li>
 *     Host data is once allocated as pinned memory 
 *     (using <code>cudaHostAlloc</code>)
 *   </li>  
 *   <li>
 *     Host data that is stored in pageable memory (comparable to 
 *     <code>malloc</code> in C), 
 *     <ul>
 *       <li>in a Java array</li>
 *       <li>a direct buffer</li>
 *     </ul>
 *   </li>  
 * </ul>      
 */
public class JCudaRuntimeMemoryBandwidths
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        run(HostMemoryMode.PINNED, hostAllocFlags);
        run(HostMemoryMode.PAGEABLE_ARRAY, hostAllocFlags);
        run(HostMemoryMode.PAGEABLE_DIRECT_BUFFER, hostAllocFlags);
    ...
    /**
     * Run the computation of the bandwidth for copying host memory to the 
     ...
     */
    static void run(HostMemoryMode hostMemoryMode, int hostAllocFlags)
    {
        int minExponent = 10;
        int maxExponent = 28;
